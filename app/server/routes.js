...
*/
	...
	app1.post('/logout', function(req, res){
...
*/
	...
	app1.post('/home', function(req, res){
		if (req.session.user == null){
			res.redirect('/');
		}	else{
			AM.updateAccount({
...
*/
	...
	app1.post('/signup', function(req, res){
		AM.addNewAccount({
			name 	: req.body['name'],
			email 	: req.body['email'],
			user 	: req.body['user'],
...
*/
	...
	app1.post('/lost-password', function(req, res){
	...
	app1.get('/reset-password', function(req, res) {
	...
	app1.post('/reset-password', function(req, res) {
...
*/
	...
	app1.get('/print', function(req, res) {
	...
	app1.get('/reset', function(req, res) {
		AM.deleteAllAccounts(function(){
			res.redirect('/print');
		});
	});

	app1.get('*', function(req, res) { res.render('404', { title: 'Page Not Found'}); });
